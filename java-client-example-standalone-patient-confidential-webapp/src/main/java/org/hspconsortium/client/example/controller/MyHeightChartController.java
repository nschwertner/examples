...
@Controller
public class MyHeightChartController {

    @Inject
    private AuthorizationCodeSessionFactory<ClientSecretCredentials> ehrSessionFactory;

    @RequestMapping(value = "/myHeightChart", method = RequestMethod.GET)
    public ModelAndView myHeightChart(ModelAndView modelAndView, HttpSession httpSession, HttpServletRequest httpRequest) {
        ...
        // note, in a real application where the patient in the user, the patient's id
        // must be determine
